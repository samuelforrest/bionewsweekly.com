            ...
            <div className="text-center space-y-10">
              ...
              <div className="grid md:grid-cols-2 gap-8 my-16">
                {[
                  ...
                  <div
                    key={index}
                    className="group text-center space-y-4 p-6 rounded-2xl hover:bg-card/30 transition-all duration-300"
                  >
                    <div
                      className={`mx-auto w-16 h-16 bg-gradient-to-r ${feature.gradient} rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 transform group-hover:scale-110`}
                    >
                ...
                {status === "success" && (
                  <div className="flex items-center justify-center gap-2 mt-4 p-4 bg-green-500/10 border border-green-500/20 rounded-xl">
                    ...
                    <p className="text-green-600 font-medium">
                      {" "}
                      Welcome to BioNewsWeekly! You'll receive our weekly
                      newsletter.
                    </p>
                  </div>
                )}
