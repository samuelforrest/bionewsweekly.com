  ...
  return (
    ...
    >
      <div className="absolute inset-0 -z-10">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-green-500/20 rounded-full blur-3xl animate-float"
      ...
      <div className="container px-6 mx-auto">
        <div className="flex flex-col items-center text-center space-y-10 max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-3 gap-8 pt-16 w-full max-w-3xl">
            <div className="group relative p-6 md:bg-card/50 md:backdrop-blur-sm md:border md:border-border/50 md:rounded-2xl md:hover:border-primary/50 transition-all duration-300 transform hover:scale-105 md:hover:shadow-lg">
