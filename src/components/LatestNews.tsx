...
export function LatestNews() {
  ...
  return (
    <section
      id="articles"
      className="py-24 lg:py-32 bg-gradient-to-br from-muted/30 via-background to-muted/30"
    >
      <div className="container px-6 mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Fresh perspectives on biology from the next generation of
            scientists, curated with passion and precision
          </p>
        </div>
            ...
            <div className="col-span-full text-center py-20">
              <div className="max-w-md mx-auto p-8 bg-card/50 backdrop-blur-sm border border-border/50 rounded-3xl">
                <p className="text-muted-foreground text-lg">
                  No articles available yet. Check back soon for exciting
                  biology news!
                </p>
              </div>
            </div>
