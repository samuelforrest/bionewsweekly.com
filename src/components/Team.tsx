...
export function Team() {
  return (
    <section
      id="team"
      className="py-24 lg:py-32 bg-gradient-to-br from-background via-muted/20 to-background"
    >
      <div className="container px-6 mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            3 Passionate A-Level students bringing fresh perspectives to biology
            news
          </p>
        </div>
        ...
        <div className="mt-20 text-center">
          <div className="max-w-2xl mx-auto p-8 bg-gradient-to-r from-primary/5 via-green-500/5 to-emerald-500/5 border border-border/50 rounded-3xl backdrop-blur-sm">
            <h3 className="text-2xl font-bold text-foreground mb-4">
              We Probably Want You!
            </h3>
            <p className="text-muted-foreground mb-6">
              We're always looking for passionate biology students to contribute
              to our mission of making intriguing biology news.
            </p>
            <a
